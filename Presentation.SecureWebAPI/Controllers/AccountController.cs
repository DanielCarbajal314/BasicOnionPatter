...
using Presentation.SecureWebAPI.Models;
using Presentation.SecureWebAPI.Providers;
using Presentation.SecureWebAPI.Results;

namespace Presentation.SecureWebAPI.Controllers
{
    [Authorize]
